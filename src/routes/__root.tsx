...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Avila's El Ranchito Santa Ana" },
      { name: "description", content: "Authentic Mexican cuisine in Santa Ana since 1966." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Avila's El Ranchito Santa Ana" },
